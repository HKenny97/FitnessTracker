// ═══════════════════════════════════════════════════════════════
// ADAPTIVE TRAINING ENGINE  —  js/adaptive.js
// ═══════════════════════════════════════════════════════════════
//
// Mines logged sets to produce real-time, personalized training
// recommendations. Falls back to EXERCISE_PROFILES defaults when
// insufficient history exists.
//
// INSTRUCTIONS FOR CLAUDE CODE:
//
// 1. Save this file as js/adaptive.js
//
// 2. In rp.js:
//    - Add EXERCISE_PROFILES and getProfile() from exercise_profiles.js
//    - Keep the existing suggestWeight / epley1RM as-is (they become
//      the static fallbacks; adaptive.js wraps them)
//
// 3. In data.js:
//    - Export a new function: getExerciseHistory(exercise)
//      (implementation provided at bottom of this file)
//
// 4. In views/workout.js — replace direct calls to suggestWeight /
//    progressRIR with calls to the adaptive engine:
//
//    import { analyze, adaptiveSuggestWeight, adaptiveSuggestReps,
//             adaptiveSuggestRest, fatigueCheck } from "../adaptive.js";
//
//    In renderExercise():
//      const analysis = await analyze(exerciseName, allSetsForExercise);
//      // analysis has everything: progression rate, rep range, rest,
//      // fatigue warnings, confidence level, and the raw stats.
//
//    Show the pills:
//      analysis.repRange.label   →  "8–12"
//      analysis.rest.label       →  "1.5–2.5 min"
//      analysis.fatigueWarning   →  null | "Fatigue accumulating — ..."
//      analysis.confidence       →  "new" | "learning" | "calibrated"
//
//    For weight suggestion:
//      adaptiveSuggestWeight(prev, targetReps, targetRIR, exerciseName, allSets)
//
// ═══════════════════════════════════════════════════════════════
